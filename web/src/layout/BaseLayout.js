  ...
  return (
    <Layout className="layout" style={{ minHeight: '100vh' }}>
      <Header style={{ padding: '0 0', height: '66px', backgroundColor: 'white', borderBottom: '1px solid #e8e8e8' }}>
        ...
        >
          <Menu.Item key="settings"><NavLink to="/settings/playlist">Settings</NavLink></Menu.Item>
          <Menu.Item key="about"><NavLink to="/about">About</NavLink></Menu.Item>
        </Menu>
      </Header>
      {children}
      <Footer style={{ textAlign: 'center' }}>©2019 <a href="http://www.tvband.cn" target="_blank" rel="noopener noreferrer">Groundhog</a></Footer>
    </Layout>
  );
}
